...
public final class Constants {
	 ...
	 * 特定用户下的树形菜单缓存关键字
	 */
	protected static final  String[] URL_SECURITY = new String[] {REQUEST_MAP_CACHE_KEY, URL_ATTRIBUTE_BY_TARGET_CACHE_KEY, URL_TREE_CACHE_KEY};
	...
	protected static final  String[] COMPONENT_SECURITY = new String[] {COMPONENT_ATTRIBUTE_MAP_CACHE_KEY};
	
	protected static final  String[] URL_COMPONENT_SECURITY = new String[] {REQUEST_MAP_CACHE_KEY, URL_ATTRIBUTE_BY_TARGET_CACHE_KEY, URL_TREE_CACHE_KEY, COMPONENT_ATTRIBUTE_MAP_CACHE_KEY};
